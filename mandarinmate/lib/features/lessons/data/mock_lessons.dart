...
List<LessonItem> generateItemsForVocab(String chinese, String pinyin, String english, String? exampleCh, String? exampleEn) {
  return [
    LessonItem(
      id: '\_vocab',
  ...
  CourseUnit(
    ...
    lessons: [
      Lesson(
        ...
        isLocked: true,
        xpReward: 30,
        items: generateItemsForVocab('你好', 'Nǐ hǎo', 'Hello', '你好！我叫小明。', 'Hello! My name is Xiao Ming.'),
      ),
      Lesson(
        id: 'u1_l2',
        title: '谢谢 - Thank You',
        ...
        isLocked: true,
        xpReward: 30,
        items: generateItemsForVocab('谢谢', 'Xiè xiè', 'Thank You', '谢谢你的帮助。', 'Thank you for your help.'),
      ),
      Lesson(
        id: 'u1_l3',
        title: '问候 - Greetings',
        ...
        isLocked: true,
        xpReward: 50,
        items: generateItemsForVocab('早上好', 'Zǎo shang hǎo', 'Good morning', '大家早上好。', 'Good morning everyone.'),
      ),
      Lesson(
        id: 'u1_l4',
        ...
        items: [
          ...
          LessonItem(
            ...
            options: ['Good morning', 'Good night', 'Hello', 'Sorry']..shuffle(),
          ),
          LessonItem(
            id: 'u1_rev_speak1',
            type: LessonType.speaking,
  ...
  CourseUnit(
    ...
    lessons: [
      Lesson(
        ...
        isLocked: true,
        xpReward: 40,
        items: generateItemsForVocab('一二三', 'Yī èr sān', 'One two three', '一二三四五。', '1 2 3 4 5.'),
      ),
      Lesson(
        id: 'u2_l2',
        title: '时间 - Time',
        ...
        isLocked: true,
        xpReward: 50,
        items: generateItemsForVocab('时间', 'Shí jiān', 'Time', '现在是什么时间？', 'What time is it now?'),
      ),
      Lesson(
        id: 'u2_l3',
  ...
  CourseUnit(
    ...
    lessons: [
      Lesson(
        ...
        isLocked: true,
        xpReward: 50,
        items: generateItemsForVocab('吃饭', 'Chī fàn', 'Eat a meal', '我们去吃饭吧。', 'Let s go eat.'),
      ),
      Lesson(
        id: 'u3_l2',
        title: '地方 - Places',
        ...
        isLocked: true,
        xpReward: 50,
        items: generateItemsForVocab('学校', 'Xué xiào', 'School', '我在学校。', 'I am at school.'),
      ),
      Lesson(
        id: 'u3_l3',
